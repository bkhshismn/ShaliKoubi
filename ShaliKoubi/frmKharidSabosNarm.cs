...
{
    public partial class frmKharidSabosNarm : Form
    {
        public frmKharidSabosNarm()
        {
            InitializeComponent();
        }
        ...
        {
            string AnbarID = "";
            tc.CommandText = "select top(1) [SabosID] from tblKSabosNarm where [SabosID] >=1 order by [SabosID] desc";
        ...
        void Display()
        {
            ...
            tc.CommandText = "select *  from   [tblKSabosNarm] as a  where a.CstmrID=" + CstmrID;
            dt = tc.ExecuteReader();
        ...
        private void frmKharidSabosNarm_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            {
                string cmdText = "insert into  [tblKSabosNarm]([WSNarm],[FSNarm],[CstmrID],[Froshande],[Majmo],[Discription],[Date])values( N'" + WDone + "'" +
                    ",N'" + FeeDone + "'" +
                    ",N'" + CstmrID + "'" +
                    ",N'" + txtFoShali.Text + "'" +
                    ",N'" + Majmo + "'" +
                ...
                //Karkhane///////////////////////////////////////////////////////////////////////////////////////////////
                cmdText += " INSERT into[tblAnbarMahsolKarkhaneSabosNarm] (VaznBed,VaznBes,MoshtariID,Date,RefProcessID,RefNoGardesh,FeeRooz,[KharidID])values" +
        ...
        {
            string cmdText = "UPDATE [tblKSabosNarm] Set [WSNarm]=N'" + WDone + "', [FSNarm]=N'" + FeeDone + "', [Froshande]=N'" + txtFoShali.Text + "', [Majmo]=N'" + Majmo + "'," +
                "[Date]=N'" + txtDate.Text + "',[Discription]=N'" + txTozihat.Text + "' where SabosID=" + Id;
            //Done/////////////////////////////////////////////////////////////////////////////////////////////////
            //Karkhane
            cmdText += " UPDATE [tblAnbarMahsolKarkhaneSabosNarm] Set [VaznBed]=N'" + WDone + "'," +
               "[FeeRooz]=N'" + FeeDone + "'," +
               "[Date]=N'" + txtDate.Text + "' where [KharidID]=" + Id;
            //Mali/////////////////////////////////////////////////////////////////////////////////////////////////
            cmdText += " UPDATE [tblHesabMoshtari] Set [bes]=N'" + Majmo + "' where ReferID=" + Id + " and [RefNoGardesh] =66";
            cmdText += " UPDATE [tblHesabKarkhane] Set [bed]=N'" + Majmo + "' where ReferID=" + Id + " and [RefNoGardesh] =66";
            if (trnsction.Execute_TRANSACTION(cmdText))
            {
                Display();
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            if (result == DialogResult.Yes)
            {
                if (Id != -1)
                {
                    ...
                    try
                    {
                        cmdText = "delete from [tblKSabosNarm] where SabosID=" + Id;
                        /////////////////////////////////////////////////////////////////////////////////////////////////
                        cmdText += " delete from [tblAnbarMahsolKarkhaneSabosNarm] where KharidID=" + Id;
                        cmdText += " delete from [tblHesabMoshtari] where ReferID=" + Id + "and [RefNoGardesh]=66";
                        cmdText += " delete from [tblHesabKarkhane] where ReferID=" + Id + "and [RefNoGardesh]=66";
                        /////////////////////////////////////////////////////////////////////////////////////////////////
