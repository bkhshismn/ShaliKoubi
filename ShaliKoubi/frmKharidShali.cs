...
namespace ShaliKoubi
{
    public partial class frmKharidShali : Form
    {
        ...
        {
            string AnbarID = "";
            tc.CommandText = "select top(1) [ShaliID] from tblKShali where [ShaliID] >=1 order by [ShaliID] desc";
        ...
        void Display()
        {
            ...
            tc.CommandText = "select b.No as NoDone ,a.*  from tblBNo  as b inner join  [tblKShali] as a on a.No=b.BNoID where a.CstmrID=" + CstmrID;
            dt = tc.ExecuteReader();
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            {
                string cmdText = "insert into  [tblKShali] ([WShali],[FShali],[CstmrID],[Froshande],[Majmo],[No],[Discription],[Date])values( N'" + WDone + "'" +
                    ",N'" + FeeDone + "'" +
                    ",N'" + CstmrID + "'" +
                    ",N'" + txtFoShali.Text + "'" +
                    ",N'" + Majmo + "'" +
                ...
                //Karkhane///////////////////////////////////////////////////////////////////////////////////////////////
                cmdText += " INSERT into[tblAnbarMahsolKarkhaneShali] (VaznBed,VaznBes,MoshtariID,Date,TedadKiseBes,TedadKiseBed,RefProcessID,RefNoGardesh,NoShali,FeeRooz,[KharidID])values" +
                "(" + WDone + ",0," + CstmrID + ",'" + txtDate.Text + "'," + 0 +
                ",0,0,33," + NoDone + "," + FeeDone + "," + KharidID + ")";

                //GhesmatMali///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                //
                //Moshtari
                cmdText += " insert into [tblHesabMoshtari]([bes],[Bed],[MoshtariID],[RefNoGardesh],[ReferID],[Takhfif],[Date],[Tozihat],[Years],[Month])values" +
               "(" + Majmo + ",0," + CstmrID + ",33," + KharidID + ",0,'" + txtDate.Text + "',0,0,0)";
                //Karkhane
                cmdText += " insert into [tblHesabKarkhane]([bes],[Bed],[MoshtariID],[RefNoGardesh],[ReferID],[Takhfif],[Date],[Tozihat],[Years],[Month])values" +
                    "(0," + Majmo + "," + CstmrID + ",33," + KharidID + ",0,'" + txtDate.Text + "',0,0,0)";
        ...
        {
            string cmdText = "UPDATE [tblKShali] Set [WShali]=N'" + WDone + "', [FShali]=N'" + FeeDone + "', [Froshande]=N'" + txtFoShali.Text + "', [Majmo]=N'" + Majmo + "'," +
                "[Date]=N'" + txtDate.Text + "',[No]=N'" + NoDone + "',[Discription]=N'" + txTozihat.Text + "' where ShaliID=" + Id;
            //Done/////////////////////////////////////////////////////////////////////////////////////////////////
            //Karkhane
            cmdText += " UPDATE [tblAnbarMahsolKarkhaneShali] Set [VaznBed]=N'" + WDone + "'," +
               "[FeeRooz]=N'" + FeeDone + "'," +
               "[Date]=N'" + txtDate.Text + "' where [KharidID]=" + Id;
            //Mali/////////////////////////////////////////////////////////////////////////////////////////////////
            cmdText += " UPDATE [tblHesabMoshtari] Set [bes]=N'" + Majmo + "' where ReferID=" + Id + " and [RefNoGardesh] =33";
            cmdText += " UPDATE [tblHesabKarkhane] Set [bed]=N'" + Majmo + "' where ReferID=" + Id + " and [RefNoGardesh] =33";
            if (trnsction.Execute_TRANSACTION(cmdText))
            {
                Display();
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            if (result == DialogResult.Yes)
            {
                if (Id != -1)
                {
                    ...
                    try
                    {
                        cmdText = "delete from [tblKShali] where ShaliID=" + Id;
                        /////////////////////////////////////////////////////////////////////////////////////////////////
                        cmdText += " delete from [tblAnbarMahsolKarkhaneShali] where KharidID=" + Id;
                        cmdText += " delete from [tblHesabMoshtari] where ReferID=" + Id + "and [RefNoGardesh]=33";
                        cmdText += " delete from [tblHesabKarkhane] where ReferID=" + Id + "and [RefNoGardesh]=33";
                        /////////////////////////////////////////////////////////////////////////////////////////////////
