...
{
    public partial class frmDasti : Form
    {
        public frmDasti()
        {
            InitializeComponent();
        ...
        private void frmDasti_Load(object sender, EventArgs e)
        {
            dgvInSearch.Visible = false;
        ...
        private void dgvInput_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            try
            {
                ...
                con.Open();
                adp.Fill(dt);
                this.txtMablagh.Text = dt.Rows[0]["Bed"].ToString();
        ...
        private void btnEdit_Click(object sender, EventArgs e)
        {
            ...
            string cmdText = "UPDATE [tblGharz] Set [Bed]=N'" + bed + "',[Date]=N'" + txtDate.Text + "',[Tozihat]=N'" + txtTozihat.Text + "' where GharzID=" + HesabId;
            //Done/////////////////////////////////////////////////////////////////////////////////////////////////
            //Karkhane

            //Mali/////////////////////////////////////////////////////////////////////////////////////////////////
            cmdText += " UPDATE [tblHesabMoshtari] Set [bed]=N'" + bed + "' where ReferID=" + HesabId + " and [RefNoGardesh] =10";
            cmdText += " UPDATE [tblHesabKarkhane] Set [bes]=N'" + bed + "' where ReferID=" + HesabId + " and [RefNoGardesh] =10";
            ...
            if (result == DialogResult.Yes)
            {
                if (HesabId != -1)
                {
                    ...
                    try
                    {
                        ...
                        /////////////////////////////////////////////////////////////////////////////////////////////////
                        cmdText += " delete from [tblHesabMoshtari] where ReferID=" + HesabId + "and [RefNoGardesh]=10";
                        cmdText += " delete from [tblHesabKarkhane] where ReferID=" + HesabId + "and [RefNoGardesh]=10";
                        /////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    bed = Convert.ToInt64(txtMablagh.Text.Replace(",", ""));
                    string cmdText = "insert into tblGharz(Bed,Date,Tozihat,MoshtariID)values(" + Convert.ToInt64(txtMablagh.Text) + ",'" + txtDate.Text + "','" + txtTozihat.Text + "'," + CstmrID + ")";
