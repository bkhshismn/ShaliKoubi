...
{
    public partial class frmFororshSabosNarm : Form
    {
        public frmFororshSabosNarm()
        {
            InitializeComponent();
        }
        ...
        {
            string AnbarID = "";
            tc.CommandText = "select top(1) [SabosID] from tblForoshSabosNarm where [SabosID] >=1 order by [SabosID] desc";
        ...
        void Display()
        {
            ...
            tc.CommandText = "select *  from   [tblForoshSabosNarm] as a  where a.CstmrID=" + CstmrID;
            dt = tc.ExecuteReader();
        ...
        {
            DataTable dt = new DataTable();
            tc.CommandText = "SELECT  sum([VaznBed]) as Kharid,sum([VaznBes]) as Forosh, (sum([VaznBed])-sum([VaznBes]))  as Mande FROM [tblAnbarMahsolKarkhaneSabosNarm] ";
            dt = tc.ExecuteReader();
            return dt;
        }
        void SetLabels()
        ...
        private void frmFororshSabosNarm_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            {
                string cmdText = "insert into  [tblForoshSabosNarm]([WSNarm],[FSNarm],[CstmrID],[Froshande],[Majmo],[Discription],[Date])values( N'" + WDone + "'" +
                    ",N'" + FeeDone + "'" +
                    ",N'" + CstmrID + "'" +
                    ",N'" + txtFoShali.Text + "'" +
                    ",N'" + Majmo + "'" +
        ...
        {
            string cmdText = "UPDATE [tblForoshSabosNarm] Set [WSNarm]=N'" + WDone + "', [FSNarm]=N'" + FeeDone + "', [Froshande]=N'" + txtFoShali.Text + "', [Majmo]=N'" + Majmo + "'," +
               "[Date]=N'" + txtDate.Text + "',[Discription]=N'" + txTozihat.Text + "' where SabosID=" + Id;
            //Done/////////////////////////////////////////////////////////////////////////////////////////////////
            //Karkhane
            cmdText += " UPDATE [tblAnbarMahsolKarkhaneSabosNarm] Set [VaznBes]=N'" + WDone + "'," +
               "[FeeRooz]=N'" + FeeDone + "'," +
               "[Date]=N'" + txtDate.Text + "' where [ForoshID]=" + Id;
            //Mali/////////////////////////////////////////////////////////////////////////////////////////////////
            cmdText += " UPDATE [tblHesabMoshtari] Set [bed]=N'" + Majmo + "' where ReferID=" + Id + " and [RefNoGardesh] =666";
            cmdText += " UPDATE [tblHesabKarkhane] Set [bes]=N'" + Majmo + "' where ReferID=" + Id + " and [RefNoGardesh] =666";
            if (trnsction.Execute_TRANSACTION(cmdText))
            {
                Display();
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            if (result == DialogResult.Yes)
            {
                if (Id != -1)
                {
                    ...
                    try
                    {
                        cmdText = "delete from [tblForoshSabosNarm] where SabosID=" + Id;
                        /////////////////////////////////////////////////////////////////////////////////////////////////
                        cmdText += " delete from [tblAnbarMahsolKarkhaneSabosNarm] where ForoshID=" + Id;
                        cmdText += " delete from [tblHesabMoshtari] where ReferID=" + Id + "and [RefNoGardesh]=666";
                        cmdText += " delete from [tblHesabKarkhane] where ReferID=" + Id + "and [RefNoGardesh]=666";
                        /////////////////////////////////////////////////////////////////////////////////////////////////
