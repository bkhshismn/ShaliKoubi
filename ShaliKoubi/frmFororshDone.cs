...
{
    public partial class frmFororshDone : Form
    {
        public frmFororshDone()
        {
            InitializeComponent();
        }
        ...
        {
            DataTable dt = new DataTable();
            tc.CommandText = "select b.No as NoDone ,a.*  from tblBNo  as b inner join  [tblForoshDone] as a on a.No=b.BNoID where a.CstmrID=" + CstmrID;
            dt = tc.ExecuteReader();
        ...
        {
            string AnbarID = "";
            tc.CommandText = "select top(1) [DoneID] from tblForoshDone where [DoneID] >=1 order by [DoneID] desc";
        ...
        private void frmFororshDone_Load(object sender, EventArgs e)
        {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            {
                string cmdText = "insert into  [tblForoshDone] ([WDone],[FDone],[CstmrID],[Froshande],[Majmo],[No],[Discription],[Date])values( N'" + WDone + "'" +
                    ",N'" + FeeDone + "'" +
                    ",N'" + CstmrID + "'" +
                    ",N'" + txtFoShali.Text + "'" +
                    ",N'" + Majmo + "'" +
                ...
                //Karkhane///////////////////////////////////////////////////////////////////////////////////////////////
                cmdText += " INSERT into[tblAnbarMahsolKarkhaneDone] (VaznBes,VaznBed,MoshtariID,Date,TedadKiseBes,TedadKiseBed,RefProcessID,RefNoGardesh,NoDone,FeeRooz,[ForoshID])values" +
                "(" + WDone + ",0," + CstmrID + ",'" + txtDate.Text + "'," + 0 +
                ",0,0,444," + NoDone + "," + FeeDone + "," + KharidID + ")";
                //GhesmatMali///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                //
                //Moshtari
                cmdText += " insert into [tblHesabMoshtari]([Bed],[bes],[MoshtariID],[RefNoGardesh],[ReferID],[Takhfif],[Date],[Tozihat],[Years],[Month])values" +
               "(" + Majmo + ",0," + CstmrID + ",444," + KharidID + ",0,'" + txtDate.Text + "',0,0,0)";
                //Karkhane
                cmdText += " insert into [tblHesabKarkhane]([Bed],[bes],[MoshtariID],[RefNoGardesh],[ReferID],[Takhfif],[Date],[Tozihat],[Years],[Month])values" +
                    "(0," + Majmo + "," + CstmrID + ",444," + KharidID + ",0,'" + txtDate.Text + "',0,0,0)";
        ...
        {
            string cmdText = "UPDATE [tblForoshDone] Set [WDone]=N'" + WDone + "', [FDone]=N'" + FeeDone + "', [Froshande]=N'" + txtFoShali.Text + "', [Majmo]=N'" + Majmo + "'," +
            ...
            //Mali/////////////////////////////////////////////////////////////////////////////////////////////////
            cmdText += " UPDATE [tblHesabMoshtari] Set [bed]=N'" + Majmo + "' where ReferID=" + Id + " and [RefNoGardesh] =444";
            cmdText += " UPDATE [tblHesabKarkhane] Set [bes]=N'" + Majmo + "' where ReferID=" + Id + " and [RefNoGardesh] =444";
            if (trnsction.Execute_TRANSACTION(cmdText))
            {
                Display();
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            if (result == DialogResult.Yes)
            {
                if (Id != -1)
                {
                    ...
                    try
                    {
                        cmdText = "delete from [tblForoshDone] where DoneID=" + Id;
                        /////////////////////////////////////////////////////////////////////////////////////////////////
                        cmdText += " delete from [tblAnbarMahsolKarkhaneDone] where ForoshID=" + Id;
                        cmdText += " delete from [tblHesabMoshtari] where ReferID=" + Id + "and [RefNoGardesh]=444";
                        cmdText += " delete from [tblHesabKarkhane] where ReferID=" + Id + "and [RefNoGardesh]=444";
                        /////////////////////////////////////////////////////////////////////////////////////////////////
