...
{
    public partial class frmForoshNimdone : Form
    {
        public frmForoshNimdone()
        {
            InitializeComponent();
        }
        ...
        {
            string AnbarID = "";
            tc.CommandText = "select top(1) [NimDID] from tblForoshNDone where [NimDID] >=1 order by [NimDID] desc";
        ...
        {
            DataTable dt = new DataTable();
            tc.CommandText = "select b.No as NoDone ,a.*  from tblBNo  as b inner join  [tblForoshNDone] as a on a.No=b.BNoID where a.CstmrID=" + CstmrID;
            dt = tc.ExecuteReader();
        ...
        private void frmForoshNimdone_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            {
                string cmdText = "insert into  [tblForoshNDone] ([WNDone],[FNDone],[CstmrID],[Froshande],[Majmo],[No],[Discription],[Date])values( N'" + WDone + "'" +
                    ",N'" + FeeDone + "'" +
                    ",N'" + CstmrID + "'" +
                    ",N'" + txtFoShali.Text + "'" +
                    ",N'" + Majmo + "'" +
                ...
                //Karkhane///////////////////////////////////////////////////////////////////////////////////////////////
                cmdText += " INSERT into[tblAnbarMahsolKarkhaneNDone] (VaznBes,VaznBed,MoshtariID,Date,RefProcessID,RefNoGardesh,[NoNDone],FeeRooz,[ForoshID])values" +
                "(" + WDone + ",0," + CstmrID + ",'" + txtDate.Text + "'," + 0 +
                ",555," + NoDone + "," + FeeDone + "," + KharidID + ")";

                //GhesmatMali///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                //
                //Moshtari
                cmdText += " insert into [tblHesabMoshtari]([Bed],[bes],[MoshtariID],[RefNoGardesh],[ReferID],[Takhfif],[Date],[Tozihat],[Years],[Month])values" +
               "(" + Majmo + ",0," + CstmrID + ",555," + KharidID + ",0,'" + txtDate.Text + "',0,0,0)";
                //Karkhane
                cmdText += " insert into [tblHesabKarkhane]([Bed],[bes],[MoshtariID],[RefNoGardesh],[ReferID],[Takhfif],[Date],[Tozihat],[Years],[Month])values" +
                    "(0," + Majmo + "," + CstmrID + ",555," + KharidID + ",0,'" + txtDate.Text + "',0,0,0)";
        ...
        {
            string cmdText = "UPDATE [tblForoshNDone] Set [WNDone]=N'" + WDone + "', [FNDone]=N'" + FeeDone + "', [Froshande]=N'" + txtFoShali.Text + "', [Majmo]=N'" + Majmo + "'," +
                "[Date]=N'" + txtDate.Text + "',[No]=N'" + NoDone + "',[Discription]=N'" + txTozihat.Text + "' where NimDID=" + Id;
            //Done/////////////////////////////////////////////////////////////////////////////////////////////////
            //Karkhane
            cmdText += " UPDATE [tblAnbarMahsolKarkhaneNDone] Set [VaznBes]=N'" + WDone + "'," +
               "[FeeRooz]=N'" + FeeDone + "'," +
               "[Date]=N'" + txtDate.Text + "' where [ForoshID]=" + Id;
            //Mali/////////////////////////////////////////////////////////////////////////////////////////////////
            cmdText += " UPDATE [tblHesabMoshtari] Set [bed]=N'" + Majmo + "' where ReferID=" + Id + " and [RefNoGardesh] =555";
            cmdText += " UPDATE [tblHesabKarkhane] Set [bes]=N'" + Majmo + "' where ReferID=" + Id + " and [RefNoGardesh] =555";
            if (trnsction.Execute_TRANSACTION(cmdText))
            {
                Display();
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            if (result == DialogResult.Yes)
            {
                if (Id != -1)
                {
                    ...
                    try
                    {
                        cmdText = "delete from [tblForoshNDone] where NimDID=" + Id;
                        /////////////////////////////////////////////////////////////////////////////////////////////////
                        cmdText += " delete from [tblAnbarMahsolKarkhaneNDone] where ForoshID=" + Id;
                        cmdText += " delete from [tblHesabMoshtari] where ReferID=" + Id + "and [RefNoGardesh]=555";
                        cmdText += " delete from [tblHesabKarkhane] where ReferID=" + Id + "and [RefNoGardesh]=555";
                        /////////////////////////////////////////////////////////////////////////////////////////////////
